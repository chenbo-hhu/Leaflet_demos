...
L.Control.GroupedLayers = L.Control.extend({
  ...
  _expand: function () {
    ...
    // Modified by chenbo-hhu to make the scrollbar better fit the map. Change original factor 4 to 1.5
    var acceptableHeight = this._map._size.y - (this._container.offsetTop * 1.5);
